        ...
        <div class="flex flex-col items-center gap-4">
            ...
            <div class="flex flex-col items-center gap-2 w-full">
                ...
                <div class="text-center w-full">
                    ...
                    <a class="text-primary font-medium ml-1 cursor-pointer hover:text-primary-emphasis">Solicita una</a>
                </div>
            </div>
        </div>
        <div class="flex flex-col gap-6 w-full">
            <div class="flex flex-col gap-2 w-full">
                <label for="email1" class="text-surface-900 dark:text-surface-0 font-medium leading-normal">Correo Electrónico</label>
                <InputText id="email1" type="text" placeholder="Email address"
                    class="w-full px-3 py-2 shadow-sm rounded-lg" />
            </div>
            <div class="flex flex-col gap-2 w-full">
                <label for="password1"
                    class="text-surface-900 dark:text-surface-0 font-medium leading-normal">Contrase&ntilde;a</label>
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between w-full gap-3 sm:gap-0">
                <div class="flex items-center gap-2">
                    ...
                    <label for="rememberme1" class="text-surface-900 dark:text-surface-0 leading-normal">Recordarme</label>
                </div>
                <a class="text-primary font-medium cursor-pointer hover:text-primary-emphasis">¿Olvidaste tu contraseña?</a>
            </div>
        </div>
        <Button label="Acceder" icon="pi pi-user" class="w-full py-2 rounded-lg flex justify-center items-center gap-2">
            <template #icon>
